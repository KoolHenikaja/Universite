  ...
  return (
    <div>
      <div className='container'>
         <h2 data-aos="fade-down" className='text-center mb-5'>Pourquoi choisissez 
          React Université ?</h2>
                ...
                h-100'>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text className='text-center'>
                          ...
                          Non ad iure magnam vero perspiciatis.
                        </Card.Text>
                    </Card.Body>
                </Card>
            </div>
            <div data-aos="fade-up" className='col-lg-4'>
                ...
                h-100'>
                    ...
                    <Card.Body>
                        <Card.Title className='text-center 
                        text-capitalize mb-3'>
                            Nous gardons l'espoir et la confiance de nos étudiants.
                        </Card.Title>
                        <Card.Text className='text-center'>
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                          Non ad iure magnam vero perspiciatis.
